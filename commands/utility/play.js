...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('play')
        .setDescription('Soittaa youtubesta linkin mukaisen kappaleen')
        .addStringOption(option => 
            option.setName('linkki')
                .setDescription('YouTube linkki')
                .setRequired(true)),
    ...
    async execute(interaction) {
        ...
        const songUrl = interaction.options.getString('linkki');
